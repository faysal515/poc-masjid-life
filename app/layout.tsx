...
const bornomala = localFont({
  src: [
    {
      path: "../public/fonts/bornomala/bornomala-regular.woff2",
      weight: "400",
      style: "normal",
    },
    {
      path: "../public/fonts/bornomala/bornomala-bold.woff2",
      weight: "700",
      style: "normal",
    },
  ],
...
export const metadata: Metadata = {
  metadataBase: new URL(process.env.NEXT_PUBLIC_SITE_URL || 'https://poc-masjid-life.vercel.app'),
  icons: {
    icon: [
  ...
  openGraph: {
    url: 'https://poc-masjid-life.vercel.app',
    title: "Masjid.Life — সুদমুক্ত ঋণ | Interest-Free Loans",
    description:
      "340 branches. 50 districts. 8,255 borrowers. 0% fee. Complete transparency.",
    type: "website",
    locale: "bn_BD",
    ...
    images: [
      { 
        ...
        width: 1200, 
        height: 1200, 
        alt: 'Masjid.Life — সুদমুক্ত ঋণ এবং বহুমুখী সেবা' 
      },
    ],
  },
  twitter: {
...
export default function RootLayout({
  ...
  return (
    <html
      ...
      className={`${bornomala.variable} ${inter.variable}`}
    >
